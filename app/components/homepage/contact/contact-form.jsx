...
function ContactForm() {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        setResponseMessage("Thanks for contacting me. There may be a problem with reaching out this message, If you have any serious query you can contact me on LinkedIn.");
        setUserInput({
          name: "",
          email: "",
          message: "",
      ...
      toast.error(error?.response?.data?.message || "Thanks for contacting me. There may be a problem with reaching out this message, If you have any serious query you can contact me on LinkedIn.", {
        position: "top-center",
        autoClose: 5000,
      });
    } finally {
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            {responseMessage && <p className="text-sm text-green-400 mt-3">{responseMessage}</p>}
          </div>
        </div>
      </div>
    </div>
